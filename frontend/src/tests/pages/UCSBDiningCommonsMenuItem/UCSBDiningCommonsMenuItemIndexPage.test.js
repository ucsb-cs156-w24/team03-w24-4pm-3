...
describe("UCSBDiningCommonsMenuItemIndexPage tests", () => {
    ...
    test("renders three menu items correctly for regular user", async () => {
        setupUserOnly();
        axiosMock.onGet("/api/ucsbdiningcommonsmenuitems/all").reply(200, menuItemFixtures.threeMenuItems);
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        axiosMock.onGet("/api/ucsbdiningcommonsmenuitems/all").reply(200, menuItemFixtures.threeMenuItems);
        axiosMock.onDelete("/api/ucsbdiningcommonsmenuitems").reply(200, "UCSBDiningCommonsMenuItem with id 2 was deleted");
