...
public class ArticlesControllerTests extends ControllerTestCase {
    ...
    public void logged_in_user_can_get_all_articles() throws Exception {
            ...
            Articles article1 = Articles.builder()
                            ...
                            .explanation("An example explanation of the article.")
    ...
    @Test
    public void an_admin_user_can_post_an_article() throws Exception {
            // arrange
            ...
            MvcResult response = mockMvc.perform(
                                post("/api/articles/post")
                                        ...
                                        .param("explanation", "An example explanation of the article.")
    ...
    public void admin_can_edit_an_existing_article() throws Exception {
            ...
            LocalDateTime ldt1 = LocalDateTime.parse("2022-01-03T00:00:00");
            LocalDateTime ldt2 = LocalDateTime.parse("2023-03-04T00:00:00");
            ...
            String requestBody = mapper.writeValueAsString(articleDateEdited);
            ...
            verify(articlesRepository, times(1)).save(articleDateEdited); // should be saved with correct user
            String responseString = response.getResponse().getContentAsString();
